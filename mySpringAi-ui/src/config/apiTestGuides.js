...
export const apiTestGuides = {
  ...
  // ────────── Image ──────────
  "/image/image": {
    summary: "基礎圖片生成：使用後端預設模型、品質與尺寸，根據 Prompt 產生圖片。",
    testPoints: [
      "比較具體與簡短 Prompt 對圖片內容、構圖及風格的影響",
      "每次生成使用 UUID 唯一檔名，不會覆蓋先前圖片",
      "前端只保存圖片 URL，切換頁面或重新整理後仍可載入歷史圖片",
      "可到後端 image-output 目錄確認實際產生的 PNG 檔案",
    ],
    sampleQueries: [
      "一隻柯基犬穿著太空衣，在月球表面散步，電影感光影",
      "雨夜的台北街道，霓虹燈倒映在路面，寫實攝影風格",
      "極簡扁平插畫：春天公園裡野餐的一家人，柔和配色",
    ],
    notes: "Clear 只會清除前端圖片紀錄，不會刪除後端 image-output 中的圖片。",
  },
  "/image/image-options": {
    summary: "進階圖片生成：可指定模型、品質與尺寸，並保留每次生成的設定紀錄。",
    testPoints: [
      "使用相同 Prompt 搭配不同 model、quality 或 size，比較生成結果",
      "確認每張歷史圖片下方顯示其 Prompt、模型、品質與尺寸",
      "每次生成使用 UUID 唯一檔名，不會覆蓋先前圖片",
      "前端只保存圖片 URL 與 options，切換頁面或重新整理後仍可載入歷史圖片",
    ],
    sampleQueries: [
      "一隻老鷹停在公園樹枝上，清晨自然光，野生動物攝影",
      "未來城市的空中捷運站，廣角構圖，科幻概念藝術",
      "高級咖啡品牌的產品廣告照，深色背景，棚拍質感",
    ],
