  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        <Routes>
          <Route index element={<Navigate to="/openai/chat-inMemory" replace />} />
          <Route path="/openai/chat-inMemory" element={<OpenaiChatInMemoryPage />} />
          ...
          <Route path="/rag/preAndPostRAAdvisor" element={<RagPreAndPostRAAdvisorPage />} />
          <Route path="/cache/redisCaching-chat" element={<CacheRedisCachingChatPage />} />
          <Route path="/cache/qdrantCaching-chat" element={<CacheQdrantCachingChatPage />} />
          <Route path="/dto/generateJsonDto" element={<DtoGenerateJsonDtoPage />} />
          <Route path="/dto/generateListJsonDto" element={<DtoGenerateListJsonDtoPage />} />
          ...
          <Route path="/tool/helpDeskTicket" element={<ToolHelpDeskTicketPage />} />
          <Route path="/email/emailResponse" element={<EmailEmailResponsePage />} />
          <Route path="/image/image" element={<ImageImagePage />} />
          <Route path="/image/image-options" element={<ImageImageOptionsPage />} />
          <Route path="/audio/transcribe" element={<AudioTranscribePage />} />
          <Route path="/audio/transcribe-options" element={<AudioTranscribeOptionsPage />} />
          <Route path="/audio/text-to-speech" element={<AudioTextToSpeechPage />} />
          <Route path="/audio/text-to-speech-options" element={<AudioTextToSpeechOptionsPage />} />
          <Route path="*" element={<div className="not-found"><strong>404</strong><h1>Page not found</h1><a href="/">Back to playground</a></div>} />
        </Routes>
      </main>
    </div>
  )
